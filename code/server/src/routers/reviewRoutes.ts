...
class ReviewRoutes {
    ...
    initRoutes() {
         ...
         */
        this.router.post(
            "/:model?", (req, res, next) => this.authenticator.isLoggedIn(req, res, next),(req, res, next) => this.authenticator.isCustomer(req, res, next),
            param("model").isString().notEmpty().exists({checkFalsy: true}), body("score").isInt({min: 1, max: 5}), body("comment").isString().notEmpty(), this.errorHandler.validateRequest,
         ...
         */
                ...
                this.router.get(
                    "/:model", (req, res, next) =>this.authenticator.isLoggedIn(req, res, next),
                    param("model").isString().notEmpty().exists({checkFalsy: true}), this.errorHandler.validateRequest,
         ...
         */
                 ...
                 this.router.delete(
                    "/:model", (req, res, next) => this.authenticator.isLoggedIn(req, res, next), (req, res, next) =>this.authenticator.isCustomer(req, res, next),
                    param("model").isString().notEmpty(),this.errorHandler.validateRequest,
         ...
         */
        this.router.delete(
            "/:model/all", (req, res, next) =>this.authenticator.isLoggedIn(req, res, next), (req, res, next) => this.authenticator.isAdminOrManager(req, res, next),
            param("model").isString().notEmpty(),this.errorHandler.validateRequest,
         ...
         */
        this.router.delete(
            "/", (req, res, next) =>this.authenticator.isLoggedIn(req, res, next), (req, res, next) => this.authenticator.isAdminOrManager(req, res, next),this.errorHandler.validateRequest,
