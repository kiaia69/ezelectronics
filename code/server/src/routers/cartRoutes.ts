...
class CartRoutes {
    ...
    initRoutes() {
         ...
         */
        this.router.get(
            "/", this.authenticator.isLoggedIn, this.authenticator.isCustomer,this.errorHandler.validateRequest,
         ...
         */
        this.router.post(
            "/", this.authenticator.isLoggedIn, this.authenticator.isCustomer, body("model").isString().notEmpty(),this.errorHandler.validateRequest,
         ...
         */
        this.router.patch(
            "/", this.authenticator.isLoggedIn, this.authenticator.isCustomer,
         ...
         */
        this.router.get(
            "/history", this.authenticator.isLoggedIn, this.authenticator.isCustomer,
         ...
         */
        this.router.delete(
            "/products/:model?", this.authenticator.isLoggedIn, this.authenticator.isCustomer, param("model").isString().notEmpty().exists({checkFalsy: true}),this.errorHandler.validateRequest,
         ...
         */
        this.router.delete(
            "/current", this.authenticator.isLoggedIn, this.authenticator.isCustomer,this.errorHandler.validateRequest,
         ...
         */
        this.router.delete(
            "/", this.authenticator.isLoggedIn, this.authenticator.isAdminOrManager,this.errorHandler.validateRequest,
         ...
         */
        this.router.get(
            "/all", this.authenticator.isLoggedIn, this.authenticator.isAdminOrManager,this.errorHandler.validateRequest,
